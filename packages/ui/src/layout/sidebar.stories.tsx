...
const eventsIcon = icon("M3.75 13.5l10.5-11.25L12 10.5h8.25L9.75 21.75 12 13.5H3.75z");
const runsIcon = icon(
  "M5.25 5.653c0-.856.917-1.398 1.667-.986l11.54 6.348a1.125 1.125 0 010 1.971l-11.54 6.347a1.125 1.125 0 01-1.667-.985V5.653z",
);
const rulesIcon = icon(
  "M6 3.75h12M6 8.25h12M6 12.75h12M6 17.25h8",
);
const connectionsIcon = icon("M7.5 21L3 16.5m0 0L7.5 12M3 16.5h13.5m0-13.5L21 7.5m0 0L16.5 12M21 7.5H7.5");
...
const workspaces: WorkspaceSwitcherEntry[] = [
  ...
  { id: "stark", name: "Stark Industries", plan: "Enterprise", avatarTone: "violet" },
];
...
export const Composed: Story = {
  ...
  render: () => {
    ...
    const current = workspaces.find((w) => w.id === currentWs) ?? workspaces[0]!;
      ...
      <div className="grid min-h-screen grid-cols-[240px_1fr] bg-page">
        ...
        <main className="p-s-10">
          ...
          <p className="max-w-[60ch] font-sans text-sm text-ink-lo">
            This story mounts the full sidebar compound with a live
            workspace switcher at the top and a live user card at the
            bottom. Use the sidebar to change routes; use the switcher to
            toggle workspaces.
          </p>
        </main>
      </div>
...
export const JustTheStatusStrip: Story = {
  render: () => (
    <div className="w-[240px] border border-hairline rounded-md overflow-hidden">
      <SidebarStatus tone="nominal" label="System Nominal" trailing="00:42:17" />
      <SidebarStatus tone="data" label="Env Manager" trailing="v0.1.0" />
      <SidebarStatus tone="caution" label="Upgrade available" trailing="1.2.0" />
