...
fn register_types(
    ...
    /* ── backtests.rs (Configure → Running → Results + runtime) ── */
    export!(emit, "backtests", BacktestStage);
    export!(emit, "backtests", BacktestRunStatus);
    export!(emit, "backtests", BacktestConfigurePhase);
    export!(emit, "backtests", BacktestAgentRole);
    export!(emit, "backtests", BacktestAgent);
    export!(emit, "backtests", BacktestDataset);
    export!(emit, "backtests", BacktestGraderKind);
    export!(emit, "backtests", BacktestGraderWeight);
    export!(emit, "backtests", BacktestGraderSource);
    export!(emit, "backtests", BacktestGrader);
    export!(emit, "backtests", BacktestGraderPreviewRow);
    export!(emit, "backtests", BacktestProposedGrader);
    export!(emit, "backtests", BacktestDataKind);
    export!(emit, "backtests", BacktestDataSourceKind);
    export!(emit, "backtests", BacktestDataSourceFilters);
    export!(emit, "backtests", BacktestDataSource);
    export!(emit, "backtests", BacktestScenarioBucket);
    export!(emit, "backtests", BacktestDataScenarioKind);
    export!(emit, "backtests", BacktestDataScenario);
    export!(emit, "backtests", BacktestData);
    export!(emit, "backtests", BacktestEnvironmentRef);
    export!(emit, "backtests", BacktestJobMode);
    export!(emit, "backtests", BacktestJobIcon);
    export!(emit, "backtests", BacktestJobPreset);
    export!(emit, "backtests", BacktestRecipe);
    export!(emit, "backtests", BacktestRunSummary);
    export!(emit, "backtests", BacktestLiveCaseStatus);
    export!(emit, "backtests", BacktestLiveCase);
    export!(emit, "backtests", BacktestCandidateProgress);
    export!(emit, "backtests", BacktestDivergenceDelta);
    export!(emit, "backtests", BacktestDivergenceSeverity);
    export!(emit, "backtests", BacktestOutcome);
    export!(emit, "backtests", BacktestDivergenceSide);
    export!(emit, "backtests", BacktestDivergence);
    export!(emit, "backtests", BacktestMetric);
    export!(emit, "backtests", BacktestQuickCheckCellState);
    export!(emit, "backtests", BacktestQuickCheckState);
    export!(emit, "backtests", BacktestsAvailability);
    export!(emit, "backtests", BacktestsScene);
    export!(emit, "backtests", JobStatus);
    export!(emit, "backtests", TrialStatus);
    export!(emit, "backtests", TrialPhase);
    export!(emit, "backtests", SandboxDriver);
    export!(emit, "backtests", RetryConfig);
    export!(emit, "backtests", JobConfig);
    export!(emit, "backtests", TrialException);
    export!(emit, "backtests", TrialTimings);
    export!(emit, "backtests", TrialResult);
    export!(emit, "backtests", TrialEvent);
    export!(emit, "backtests", BacktestJobRecord);
    export!(emit, "backtests", BacktestTrialRecord);
    export!(emit, "backtests", BacktestTrialRewardRecord);
    export!(emit, "backtests", BacktestArtifactKind);
    export!(emit, "backtests", BacktestArtifactRecord);
    export!(emit, "backtests", CreateBacktestJobInput);
    export!(emit, "backtests", CreateBacktestTrialInput);
