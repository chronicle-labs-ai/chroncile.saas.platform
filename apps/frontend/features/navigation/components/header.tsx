        ...
        <div className="hidden lg:flex items-center gap-6">
          <div className="flex items-baseline gap-1.5">
            ...
            {statsLoading ? (
              ...
              <span className="font-mono text-[13px] text-nominal font-medium tabular-nums leading-none">
                {eventsCount}
              </span>
            )}
          </div>
          ...
          <div className="flex items-baseline gap-1.5">
            {statsLoading ? (
              ...
              <div
                className={`status-dot relative top-[-1px] ${
                  connectionsCount > 0
            ...
            {statsLoading ? (
              ...
              <span className="font-mono text-[13px] text-data font-medium tabular-nums leading-none">
                {connectionsCount}
              </span>
            )}
          </div>
          ...
          <div className="flex items-baseline gap-1.5">
            ...
            {statsLoading ? (
              ...
              <span className="font-mono text-[13px] text-primary font-medium tabular-nums leading-none">
                99.9%
              </span>
            )}
          </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="relative" ref={dropdownRef}>
            ...
            >
              ...
              <svg
                className={`w-3 h-3 text-tertiary transition-transform duration-fast ${
            ...
            {dropdownOpen && (
              <div className="absolute right-0 mt-1 w-56 bg-surface border border-border-default shadow-lg">
                <div className="px-3 py-3 border-b border-border-dim bg-elevated">
                  <div className="text-[10px] text-tertiary mb-1 uppercase tracking-wide">
                    Operator
                  </div>
