    ...
    icon: (
      ...
      >
        <path
          ...
          d="M3 8.689c0-.864.933-1.406 1.683-.977l7.108 4.061a1.125 1.125 0 010 1.954l-7.108 4.061A1.125 1.125 0 013 16.811V8.689zM12.75 8.689c0-.864.933-1.406 1.683-.977l7.108 4.061a1.125 1.125 0 010 1.954l-7.108 4.061a1.125 1.125 0 01-1.683-.977V8.689z"
        />
      </svg>
    ),
  },
    ...
    <div>
      <div className="flex border-b border-border-dim mb-6">
        {tabs.map((tab) => (
          ...
          >
            <span
              className={activeTab === tab.id ? "text-data" : "text-tertiary"}
            >
              {tab.icon}
            </span>
            {tab.label}
            ...
            <div className="panel">
              <div className="panel__content text-center py-8">
                <p className="text-sm text-secondary">
                  Backend must be running and healthy to view tenants
                </p>
        ...
        <div className="space-y-6">
          {env.status === "RUNNING" || env.type === "LOCAL" ? (
            ...
            <div className="panel">
              <div className="panel__content text-center py-8">
                <p className="text-sm text-secondary">
                  Resources available once environment is running
                </p>
              </div>
            </div>
          )}
      ...
      {activeTab === "database" && env.type === "LOCAL" && <DatabaseTab />}
    </div>
  );
}
    ...
    <>
      ...
      <div className="max-w-6xl mx-auto space-y-6">
        <div>
          <Link
            href="/dashboard"
            className="btn btn--ghost btn--sm mb-4 inline-flex"
          >
          ...
          <div className="flex items-start justify-between">
            <div className="flex items-center gap-3">
              ...
              <span
                className={`status-dot ${env.isHealthy ? "status-dot--nominal status-dot--pulse" : "status-dot--critical"}`}
              />
            </div>
            <div className="flex items-center gap-3">
